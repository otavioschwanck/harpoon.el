...
| harpoon-project-name-function | Function to get project name | 'projectile-project-name |
| harpoon-project-root-function | Function to get project root | 'projectile-project-root |
